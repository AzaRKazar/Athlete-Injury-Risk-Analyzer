...
model_dir = os.path.join(project_root, 'trained-model')
...
all_potential_features = [
    ...
    'days_since_first_test'  # We'll check if this exists
]

# Filter to only include features that exist in the dataframe
indirect_features = [feat for feat in all_potential_features if feat in df.columns]
print(f"Using these features that exist in the dataset: {indirect_features}")
